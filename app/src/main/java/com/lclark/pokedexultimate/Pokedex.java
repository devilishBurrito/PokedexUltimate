...
public class Pokedex {
    ...
    private ArrayList<com.lclark.pokedexultimate.Pokemon> mPokemons;
    private int mPokemonIndex = 0;

    public Pokedex() {
        mPokemons = new ArrayList<>();
        for (String pokemonStr : mPokemonStrs) {
            mPokemons.add(new com.lclark.pokedexultimate.Pokemon(pokemonStr));
        }
    }

    public List<com.lclark.pokedexultimate.Pokemon> getPokemons(int count) {
    ...
    public com.lclark.pokedexultimate.Pokemon getPokemon() {
        mPokemonIndex = mPokemonIndex % mPokemons.size();
        com.lclark.pokedexultimate.Pokemon pokemon =  mPokemons.get(mPokemonIndex);
        mPokemonIndex++;
        return pokemon;
    }

    public ArrayList<com.lclark.pokedexultimate.Pokemon> getPokemons() {
        return mPokemons;
    }
